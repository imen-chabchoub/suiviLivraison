...
export default function HomeScreen({ navigation }) {
  ...
  const handleMap   = (d) => navigation.navigate('Map', { delivery: d });
  const handleScan  = (d) => navigation.navigate('Scanner', { delivery: d });
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.tabContainer}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('History')} // NAVIGATION
        >
