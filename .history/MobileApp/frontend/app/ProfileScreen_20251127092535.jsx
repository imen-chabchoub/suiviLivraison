...
export default function ProfileScreen() {
  ...
  const [email, setEmail] = useState('jean.dupont@delivery.com');
  const [phone, setPhone] = useState('+33 6 12 34 56 78');
  const [address, setAddress] = useState('15 Rue de la Livraison, 75001 Paris');
  ...
  const originalData = {
    ...
    address: '15 Rue de la Livraison, 75001 Paris',
    vehicleType: 'Voiture',
    plate: 'AB-123-CD',
  };
        ...
        <View style={styles.userCard}>
          ...
          <View style={styles.statsContainer}>
            ...
            <View style={styles.stat}>
              ...
              <Text style={styles.statNumber}>4.7/5</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.vehicleRow}>
            ...
            {isEditing ? (
              ...
              <Text style={[styles.vehicleValue, { fontWeight: 'bold' }]}>{plate}</Text>
            )}
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  logoutText: { marginLeft: 8, fontSize: 16, fontHKWeight: '600', color: '#ef4444' },
});